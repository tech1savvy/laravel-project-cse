...
@section('content')
    ...
    <!-- Services Section -->
    @php
        $services = \App\Models\Service::all(); // or set to an empty array if no services exist
    @endphp
    @include('partials.service', ['services' => $services])
    
    <!-- Projects Section -->
    @php
        $projects = \App\Models\Project::all(); // or set to an empty array if none exists
    @endphp
    @include('partials.project', ['projects' => $projects])
